...
const commands = [
	...
	new SlashCommandBuilder().setName('council').setDescription('Show CR council information'),
  new SlashCommandBuilder().setName('election').setDescription('Show CR election status'),
	...
	new SlashCommandBuilder().setName('ping').setDescription('Show status of CR Bot'),
